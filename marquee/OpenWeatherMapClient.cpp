...
int OpenWeatherMapClient::setGeoLocation(const String &location) {
  ...
  //Serial.println("IN setGeoLocation with " + location + " as input");
  //Serial.println("len="+String(len)+" comma="+String(comma)+" decimal="+String(decimal)+" ch_cnt_digits="+String(ch_cnt_digits)+" ch_cnt_letters="+String(ch_cnt_letters));
  //Serial.println("location.toInt()="+String(location.toInt()));
